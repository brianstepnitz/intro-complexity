...
to async-step
  ask turtles [
    ...
    ask my-neighborhood with [points < 0] [
      compete-with-my-neighborhood
    ]
...
This model presents a two-dimensional world of agents which iteratively play the Prisoner's Dilemma among their spatial neighbors with only the strategies "Always Cooperate" or "Always Defect". After each contest, depending on the rules defined during setup, agent strategies may be replaced by the other strategy.
